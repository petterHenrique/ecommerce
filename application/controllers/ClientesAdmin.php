...
class ClientesAdmin extends MasterLogado {

	public function index()
	{
		$this->load->model("Clientes");
		$dados['clientes'] = $this->Clientes->buscarClientes();
		$this->load->view('/upadmin/clientes/index', $dados);
	}
	...
	public function pesquisarPagina(){
		...
		if(!empty($dados)){
			...
			if(count($resultado)>0){
				...
				$this->load->view("/upadmin/paginas/pesquisaPaginas", $result);
			}else{
				$result["paginas"] = $this->PaginasAdminModel->buscarTodasPaginas();
				$this->load->view("/upadmin/paginas/pesquisaPaginas", $result);
			}
		}else{
