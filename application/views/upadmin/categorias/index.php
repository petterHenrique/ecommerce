        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <h2 class="page-header text-primary">Categorias</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
            	<div class="col-lg-12 col-md-12 col-sm-12">
            		<button class="btn btn-default pull-right" onclick="window.location.href='<?=base_url()?>index.php/categoriasadmin/criar'"><i class="fa fa-plus-circle" aria-hidden="true"></i>
 Adicionar</button>
