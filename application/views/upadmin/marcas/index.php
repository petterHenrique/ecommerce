            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <a href="/index.php/marcasAdmin/criar" class="btn btn-default my-4">
                        ...
                        <table class="table table-striped">
                            ...
                            <?php foreach ($marcas as $item) { ?>
                                <tr data-codigo="<?=$item['COD_MARCA']?>">
                                    ...
                                    <td class="text-right">
                                        <i onclick="window.location.href='/index.php/marcasAdmin/editar?id=<?=$item['COD_MARCA']?>'" style="cursor:pointer;"  class="fa fa-pencil text-primary btn-editar" aria-hidden="true"></i>
                                        &nbsp;&nbsp;
                                        <i style="cursor:pointer;" class="fa fa-trash-o text-danger btn-remover" aria-hidden="true"></i></td>
                                </tr>
                            <?php	} ?>
                            </tbody>
                        </table>
